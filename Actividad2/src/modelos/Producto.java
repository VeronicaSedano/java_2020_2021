...
public class Producto implements Serializable {
	...
	public Producto(Long id, String nombre, String descripcion, String urlImagen, BigDecimal precio, Integer descuento,
			String unidadMedida, BigDecimal precioUnidadMedida, Integer cantidad, BigDecimal totalParcial) {
		super();
		this.id = id;
		this.nombre = nombre;
	...
	public BigDecimal getTotalParcial() {
		// multiplico precio del producto por la cantidad
		return getPrecioConDescuento().multiply(new BigDecimal(cantidad));
	...
	public int hashCode() {
		...
		result = prime * result + ((totalParcial == null) ? 0 : totalParcial.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (totalParcial == null) {
			if (other.totalParcial != null)
				return false;
		} else if (!totalParcial.equals(other.totalParcial))
			return false;
	...
	public String toString() {
		return "Producto [id=" + id + ", nombre=" + nombre + ", descripcion=" + descripcion + ", urlImagen=" + urlImagen
				...
				+ ", precioUnidadMedida=" + precioUnidadMedida + ", cantidad=" + cantidad + ", totalParcial="
				+ totalParcial + "]";
	}
